                ...
                <div class="relative bg-white rounded-xl shadow-xl max-w-md w-full p-6 max-h-[90vh] overflow-y-auto overscroll-contain">
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <input v-model="novoUser.form.value.name" class="form-input" placeholder="Ex.: João Silva">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-700 mb-1">E-mail *</label>
                            <input v-model="novoUser.form.value.email" type="email" class="form-input" placeholder="joao@exemplo.com">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-700 mb-1">Papel *</label>
                            <select v-model="novoUser.form.value.role" class="form-input">
