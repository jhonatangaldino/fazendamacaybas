...
const grupos = [
    {
        ...
        tom: 'primary',
        itens: [
            { id: 'pesar-animal',         nome: 'Registrar peso do animal',   desc: 'Anotar o peso atual',              emoji: '⚖️', rota: 'admin.rebanho.animais.index',    query: { acao: 'pesar' },       perm: 'operational.rebanho.eventos.create' },
            ...
            { id: 'receber-mercadoria',   nome: 'Receber mercadoria',         desc: 'Entrada + nota fiscal',            emoji: '📦', rota: 'admin.estoque.movimentos.index',  query: { novo: 1, tipo: 'entrada', motivo: 'compra' }, perm: 'operational.estoque.movimentos.create' },
            ...
            { id: 'criar-tarefa',         nome: 'Criar tarefa',               desc: 'Passar um serviço ao funcionário', emoji: '📋', rota: 'admin.tarefas.index',             query: { novo: 1 },           perm: 'operational.funcionarios.tarefas.create' },
    ...
    },
    {
        ...
        tom: 'sky',
        itens: [
            { id: 'vacinar-animal',       nome: 'Aplicar vacina no animal',   desc: 'Registrar vacinação',              emoji: '💉', rota: 'admin.rebanho.animais.index',    query: { acao: 'vacinar' },     perm: 'operational.rebanho.eventos.create' },
            { id: 'medicar-animal',       nome: 'Aplicar medicamento',        desc: 'Tratamento do animal',             emoji: '💊', rota: 'admin.rebanho.animais.index',    query: { acao: 'medicar' },     perm: 'operational.rebanho.eventos.create' },
            { id: 'vermifugar-animal',    nome: 'Aplicar vermífugo',          desc: 'Vermifugação do rebanho',          emoji: '🧴', rota: 'admin.rebanho.animais.index',    query: { acao: 'vermifugar' },  perm: 'operational.rebanho.eventos.create' },
            { id: 'aplicar-defensivo',    nome: 'Aplicar produto na plantação', desc: 'Herbicida, fungicida, inseticida', emoji: '🌿', rota: 'admin.agricola.aplicacoes.index', query: { novo: 1, tipo: 'herbicida' },  perm: 'operational.agricola.aplicacoes.create' },
            { id: 'aplicar-adubo',        nome: 'Aplicar adubo na plantação', desc: 'Adubação de talhão',               emoji: '🌱', rota: 'admin.agricola.aplicacoes.index', query: { novo: 1, tipo: 'adubacao' },   perm: 'operational.agricola.aplicacoes.create' },
            { id: 'manutencao-maquina',   nome: 'Arrumar máquina',            desc: 'Trator, caminhão, implemento',     emoji: '🔧', rota: 'admin.maquinas.manutencoes.index', query: { novo: 1, tipo: 'corretiva' }, perm: 'operational.maquinas.manutencoes.create' },
            { id: 'mover-lote',           nome: 'Mover animal de lote',       desc: 'Trocar animal entre lotes',        emoji: '🐄', rota: 'admin.rebanho.animais.index',    query: { acao: 'mover' },       perm: 'operational.rebanho.eventos.create' },
            { id: 'observar-animal',      nome: 'Registrar observação do animal', desc: 'Cio, cobertura, anotação',     emoji: '📝', rota: 'admin.rebanho.animais.index',    query: { acao: 'observar' },    perm: 'operational.rebanho.eventos.create' },
        ],
    },
    {
        id: 'safra',
        ...
        itens: [
            ...
            { id: 'ajustar-estoque',      nome: 'Ajustar estoque',            desc: 'Corrigir saldo do armazém',        emoji: '🔢', rota: 'admin.estoque.movimentos.index',  query: { novo: 1, tipo: 'ajuste' }, perm: 'operational.estoque.movimentos.create' },
        ],
    },
    {
        id: 'ocasional',
        ...
        tom: 'slate',
        itens: [
            { id: 'registrar-morte',      nome: 'Registrar morte do animal',  desc: 'Baixa por mortalidade',            emoji: '⚰️', rota: 'admin.rebanho.animais.index',  query: { acao: 'morte' },     perm: 'operational.rebanho.eventos.create' },
