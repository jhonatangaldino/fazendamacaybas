...
const grupos = [
    ...
    },
    {
        ...
        itens: [
            ...
            { id: 'mover-lote',           nome: 'Mover animal de lote',       desc: 'Passo a passo guiado',             emoji: '🐄', rota: 'admin.fluxos.evento-rebanho',    query: { tipo: 'movimentacao' }, perm: 'operational.rebanho.eventos.create', destaque: true },
